...
add_argument(
    ...
    default="lm",
    dtype=str,
    choices=["lm", "cbow", "adapt_lm", "adapt_cbow", "decipher", "search", "extract"],
...
class DecipherManager(BaseManager):
    ...
    add_argument("train_phi", dtype=bool, default=False, msg="Flag to train phi score. Used only with supervised mode.")
